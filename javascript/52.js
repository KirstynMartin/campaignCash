(function(){
	...
	var radiusScale = d3.scaleSqrt().domain([0, 29461039]).range([1, 130])
    ...
    // This code sets the parameters for the image bg
		...
		d3.select("#top52").on('click', function() {
			simulation
		...
		d3.select("#total52").on('click', function() {
			simulation
			  .force("x", forceXCombine)
			  .alphaTarget(0.5)
			  .restart()
